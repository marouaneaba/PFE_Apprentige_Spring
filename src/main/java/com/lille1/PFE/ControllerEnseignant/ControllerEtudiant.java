...
public class ControllerEtudiant {
    ...
    public RedirectView  setFormAjoutEtudiant(@RequestParam("pseudo")String name,@RequestParam("password")String password
    		,@RequestParam("email_address")String email, ModelMap pModel) {
	...
	public String listerEtudiant(HttpServletRequest request,Model model){
		...
		/*List<Etudiant> etudiants = mEtudiantService.convertIterableToList(mEtudiantService.getAllEtudiant());
		for(Etudiant etudiant : etudiants){
			System.out.println("etu : "+etudiant+ ", size connaissance :"+etudiant.getConnaissances().size());
		}*/
